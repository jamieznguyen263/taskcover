...
function auditPerformance(files: string[]) {
  ...
  addFinding("perf", homeByLocale.every(([, home]) => home.heroVideo.videoUrl === undefined), "hero-video-no-default-media", "critical", "Homepage hero video has no real or fake video URL by default.");
  addFinding("perf", read("src/components/marketing/home/spokesperson-video-card.tsx").includes('preload="none"'), "hero-video-preload-none", "high", "Future hero video media uses preload=\"none\".");
  addFinding("perf", !read("src/components/marketing/home/spokesperson-video-card.tsx").includes("autoPlay"), "hero-video-no-autoplay", "high", "Hero video component does not autoplay media.");
