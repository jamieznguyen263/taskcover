...
export const generateMetadata = (props: LocalizedTrustProps) => localizedTrustMetadata("cookie-preferences", props);

export default function Page(props: LocalizedTrustProps) {
  return <LocalizedTrustPage slug="cookie-preferences" props={props} />;
}
