...
export const generateMetadata = (props: LocalizedTrustProps) => localizedTrustMetadata("privacy-policy", props);

export default function Page(props: LocalizedTrustProps) {
  return <LocalizedTrustPage slug="privacy-policy" props={props} />;
}
