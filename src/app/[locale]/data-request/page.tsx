...
export const generateMetadata = (props: LocalizedTrustProps) => localizedTrustMetadata("data-request", props);

export default function Page(props: LocalizedTrustProps) {
  return <LocalizedTrustPage slug="data-request" props={props} />;
}
