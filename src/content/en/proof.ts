...
export const proof: ProofContent = {
  ...
  hub: {
    metaTitle: "Proof and Authority System",
    metaDescription:
  ...
  pages: {
    "brand-experience": {
      ...
      label: "Brand Experience",
      metaTitle: "Brand Experience Context",
      metaDescription:
    ...
    "media-features": {
      slug: "media-features",
      label: "Media Features",
      metaTitle: "Media Features and Commentary",
      metaDescription:
    ...
    "client-reviews": {
      slug: "client-reviews",
      label: "Client Reviews",
      metaTitle: "Verified Client Reviews",
      metaDescription:
    ...
    "video-reviews": {
      slug: "video-reviews",
      label: "Video Reviews",
      metaTitle: "Verified Video Reviews",
      metaDescription:
    ...
    spokesperson: {
      slug: "spokesperson",
      label: "Spokesperson",
      metaTitle: "Search and AI Spokesperson Commentary",
      metaDescription:
