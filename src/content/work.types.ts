...
export type WorkContent = {
  ui: {
    ...
    verifiedOutcomesByGrowthLever: string;
    serviceToProofMap: string;
    usedInCaseStudies: string;
    viewService: string;
    viewRelatedCases: string;
    growthLever: string;
    metricContext: string;
    caseToResultMatrix: string;
    resultCategories: string;
    industryMarketDistribution: string;
