/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 7ced43a910f4d9471bf5f0739735ee01)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	HYPERDRIVE: Hyperdrive;
	ASSETS: Fetcher;
	NEXTJS_ENV: "production";
	APP_URL: "https://staging.taskcover.com" | "https://taskcover.com";
	NEXT_PUBLIC_APP_URL: "https://staging.taskcover.com" | "https://taskcover.com";
	INSIGHTS_PROVIDER: "local";
	PUBLISH_SCHEDULER_PROVIDER: "cloudflare-cron";
	RATE_LIMIT_PROVIDER: "cloudflare";
	AUTH_RATE_LIMIT_PROVIDER: "cloudflare";
	RATE_LIMIT_NAMESPACE: "taskcover-leads-staging" | "taskcover-leads";
	AUTH_RATE_LIMIT_NAMESPACE: "taskcover-admin-auth-staging" | "taskcover-admin-auth";
	CLOUDINARY_UPLOAD_FOLDER: "taskcover-staging/insights" | "taskcover/insights";
	LEAD_RATE_LIMITER?: RateLimit;
	ADMIN_RATE_LIMITER?: RateLimit;
	RATE_LIMIT_COORDINATOR?: DurableObjectNamespace<import("./worker/taskcover-worker").RateLimitCoordinator>;
	WORKER_SELF_REFERENCE?: Service<typeof import("./worker/taskcover-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/taskcover-worker");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "APP_URL" | "NEXT_PUBLIC_APP_URL" | "INSIGHTS_PROVIDER" | "PUBLISH_SCHEDULER_PROVIDER" | "RATE_LIMIT_PROVIDER" | "AUTH_RATE_LIMIT_PROVIDER" | "RATE_LIMIT_NAMESPACE" | "AUTH_RATE_LIMIT_NAMESPACE" | "CLOUDINARY_UPLOAD_FOLDER">> {}
}
